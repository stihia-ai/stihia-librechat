...
class TestMissingUpstream:
    ...
    def test_anthropic_missing_upstream(self, client):
        resp = client.post(
            "/v1/messages",
            json={"messages": [{"role": "user", "content": "hi"}]},
        )
    ...
    def test_gemini_generate_missing_upstream(self, client):
        resp = client.post(
    ...
    def test_gemini_stream_missing_upstream(self, client):
        resp = client.post(
